...
public class SimpleController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<String> items = FXCollections.observableArrayList("Tarjeta", "Efectivo", "Bizum");
        comboBox1.setItems(items);

        // Configurar elementos del ChoiceBox
        ObservableList<String> items1 = FXCollections.observableArrayList("Online", "Presencial", "Semipresencial");
    ...
    private void mostrarResultado() {
        try {
            ...
            if (radioButtonParticular.isSelected()) {
                mensaje.append("RadioButton seleccionado: Con portatil\n");
            } else if (radioButtonEmpresa.isSelected()) {
                mensaje.append("RadioButton seleccionado: Sin portatil\n");
            }
